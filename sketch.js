...
//loading all images//
function preload() {
  ocean = loadImage("ocean_3_new.gif");
...
function setup() {
  ...
  //starts audio upon load//
  ele.loop();
}

function theAlert1_f() {
  alert(
    "Tropical fish are a type of fish that live in the tropical waters, areas of warm water found near the equator. Tropical fish with vibrant colors and patterns are one of the prominent features of the reef ecosystem. Interestingly, these creatures have well-developed vision and can recognize different colors and color patterns. There are over 30,000 species of tropical fish."
  );
}

function theAlert2_f() {
  alert(
    "Jellyfish have no brain, heart, bones or eyes. They are made up of a smooth, bag-like body and tentacles armed with tiny, stinging cells. These incredible invertebrates use their stinging tentacles to stun or paralyse prey before gobbling it up.There are more than 2,000 known species of jellyfish"
  );
}
